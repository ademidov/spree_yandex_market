        ...
        xml.yml_catalog(:date => Time.now.to_s(:ym)) {
          ...
          xml.shop { # описание магазина
            ...
            xml.offers { # список товаров
              product_group = Spree::ProductGroup.find_by_id(@config.preferred_product_group).try(:products) || Spree::Product
              products = product_group.active.master_price_gte(0.001)
